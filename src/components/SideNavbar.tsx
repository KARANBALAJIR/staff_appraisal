...
function SideNavbar() {
  return (
    <div>
      <Disclosure as="nav">
        <div className="p-6 w-full h-screen bg-blue-100 z-20 top-30 -left-96 lg:left-0 lg:w-60  peer-focus:left-0 peer:transition ease-out delay-150 duration-200">
